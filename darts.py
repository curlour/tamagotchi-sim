...
def game(avars, asprs, screen):
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/dartst.png").convert()

    gamebk = pygame.image.load("Sprites/Misc/bg/gamecenter.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/darts.png").convert()
    ...
    drt1 = pygame.image.load("Sprites/Misc/obj/dart1.png").convert()
    drt2 = pygame.image.load("Sprites/Misc/obj/dart2.png").convert()
        ...
        if tuts:
            ...
            if not thr:
                if anifr < 12:
                    ...
                    apos -= 1
                screen.blit(arrow, [(32 + (14 * apos)), 80])
            else:
                if anifr < 20:
                    screen.blit(drt2, [((144 + (14 * apos)) // 2), 106])
                else:
                    screen.blit(drt1, [(30 + (14 * apos)), 56])
            screen.blit((fnt.render(("%03d" % scr), 1, (0, 0, 100))), [8, 36])
            screen.blit((fnt.render(str(drts - 1), 1, (0, 0, 100))), [36, 116])
        else:
            screen.blit(gamebk, [0, 0])
            if end == 3:
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    elif play and not thr and 24 < mp[1] < 136:
                        thr = True
                        anifr = 15
                        pygame.mixer.stop()
                        sound[6].play()
            ...
            if play:
                if thr:
                    ...
                    if drts == 0:
                        ...
                        if (avars[avars[3][5]][17] + (scr // 125)) < 6:
                            avars[avars[3][5]][17] += (scr // 125)
                        else:
