...
def game(avars, asprs, screen):
    ...
    def getscr(clkt):
        scrim = pygame.image.load("Sprites/Misc/bg/tamaxs.png")
        scrim.set_palette_at(1, [(80, 204, 255), (204, 153, 255), (255, 153, 204), (255, 128, 128)][clkt])
        scrim.convert()
        return(scrim)
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/tamaxt.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/tamax.png").convert()

    desk = pygame.image.load("Sprites/Misc/bg/tamaxd.png").convert()
    ...
    while kr:
        if tuts:
            ...
            if end == 0:
                ...
                spr = 5 + (2 * (ccnt != [clkt, clka]))
            screen.blit(scrim, [12, 36])
            screen.blit(fnt.render(str(clka), 1, (0, 0, 100)), [40, 46])
            screen.blit(asprs[avars[3][5]][spr], [104, 56])
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    if (104 < mp[1] < 136) and play and end == 0:
                        c = (mp[0] > 119) + (2 * (mp[1] > 119))
                        if c == ccnt[0]:
                            ccnt[1] += 1
                        else:
                            ccnt[0] = c
