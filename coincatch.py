...
def game(avars, asprs, screen):
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/coincatcht.png").convert()

    gamebk = pygame.image.load("Sprites/Misc/bg/gamecenter.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/coincatch.png").convert()
    ...
    obj = pygame.image.load("Sprites/Misc/obj/cncthobj.png").convert()
    ...
    while kr:
        if tuts:
            ...
            screen.blit(obj, [113, (63 + (12 * objpos))])
            if end == 0 or end == 1:
                if btn:
                    spr = 17
                else:
                ...
                if end == 0:
                    if thpos < 17:
                        for i in [0, 1, 2]:
                            if (thpos < 15) or (i == objpos):
                                screen.blit([poo, coin][thlist[i]], [(232 - (thpos * 8)), (56 + (12 * i))])
                    else:
                        a = objpos + ((anifr - 12) // 3)
                        if a < 3:
                            screen.blit([poo, coin][thlist[objpos]], [96, (56 + (12 * a))])
            elif end == 2:
                if anifr < 12:
                    if scr < 12:
                        screen.blit(poo, [96, 110])
                    else:
                        screen.blit(coin, [90, 108])
                        screen.blit(coin, [102, 108])
                        screen.blit(coin, [96, 110])
                else:
                    if scr < 12:
                        screen.blit(poo, [96, 120])
                    else:
                        screen.blit(coin, [86, 120])
                        screen.blit(coin, [106, 120])
                        screen.blit(coin, [96, 120])
                if anifr < 8 or anifr == 23:
                    spr = 3
                else:
                    if scr < 12:
                        spr = 9
                        ...
                        spr = 5
            screen.blit(pygame.transform.flip(asprs[avars[3][5]][spr], 1, 0), [(44 + (32 - asprs[avars[3][5]][spr].get_width())), (84 + (32 - asprs[avars[3][5]][spr].get_height()))])
            screen.blit((fnt.render(("%02d" % scr), 1, (0, 0, 100))), [131, 109])
        else:
            screen.blit(gamebk, [0, 0])
            if end == 3:
                ...
                if anifr < 8:
                    ...
                    mntxt = fnt.render(str((scr * 50) // 3), 1, (0, 0, 100))
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    elif (24 < mp[1] < 136) and end == 0 and play and thpos < 15:
                        btn = True
                        pygame.mixer.stop()
                        sound[2].play()
                        if objpos > 0:
                    ...
                    if (24 < mp[1] < 136) and end == 0 and play and thpos < 15:
                        btn = True
                        pygame.mixer.stop()
                        sound[2].play()
                        if objpos < 2:
        ...
        if anifr < 23:
            ...
            if strt:
                play = True
                strt = False
            elif end == 0 and play and thpos == 17:
                if thlist[objpos] == 1:
                    scr += 1
                    thpos = 0
                if scr == 12 or thpos == 17:
                    end = 1
                    anifr = 18
                else:
                    pygame.mixer.stop()
                ...
                ret = 0
                return(avars, ret)
        if thpos < 17 and play and end == 0:
            if anifr % (6 - (scr // 2)) == 0:
                 thpos += 1
                 if thpos == 17:
                     anifr = 12
