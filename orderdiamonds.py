...
def game(avars, asprs, screen):
    ...
    while kr:
        if tuts:
            ...
            screen.blit(asprs[avars[3][5]][spr], [(sprx + ((32 - asprs[avars[3][5]][spr].get_width()) // 2)), (spry + (32 - asprs[avars[3][5]][spr].get_height()))])
        else:
            screen.blit(gamebk, [0, 0])
            if end == 3:
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    elif 24 < mp[1] < 136 and 82 < mp[0] < 226 and play and pbt and pprt > 3:
                        pprt = (mp[0] - 82) // 36
                        anifr = 15
                        if pprt == dord[0]:
                            dlst.append(dord[0])
