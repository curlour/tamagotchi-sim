...
def game(avars, asprs, screen):
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/towert.png").convert()

    gamebk = pygame.image.load("Sprites/Misc/bg/gamecenter.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/tower.png").convert()

    blks = [[pygame.image.load("Sprites/Misc/obj/twb1.png").convert(),
             pygame.image.load("Sprites/Misc/obj/twb2.png").convert()],
            [pygame.image.load("Sprites/Misc/obj/twd1.png").convert(),
             pygame.image.load("Sprites/Misc/obj/twd2.png").convert()]]

    ham = [pygame.image.load("Sprites/Misc/obj/twh1.png").convert(),
             pygame.image.load("Sprites/Misc/obj/twh2.png").convert()]

    har = pygame.transform.flip(pygame.image.load("Sprites/Misc/txtbox/arrow1.png").convert(), 1, 0)
    ...
    while kr:
        if tuts:
            ...
            if end == 0:
                apos = (apos + 1) % 7
                spr = 3 + (anifr % 12 > 5)
                screen.blit(blks[blst[0]][0], [104, 97])
                screen.blit(ham[0], [152, 82])
                screen.blit(har, [136, (73 + (8 * apos))])
            else:
                spr = 5 + (4 * (apos not in [3, 4]))
                screen.blit(blks[blst[0]][apos in [3, 4]], [(104 - (72 * (len(blst) > 1 and apos in [3, 4]))), 97])
                screen.blit(ham[1], [136, (69 + (8 * apos))])
            for i in range(1, 6):
                if blst[i - 1] == 1:
                    break
                screen.blit(blks[blst[i]][0], [(104 + (i * (end == 1 and apos not in [3, 4]))), (97 - (16 * i))])
            screen.blit(asprs[avars[3][5]][spr], [(152 + ((32 - asprs[avars[3][5]][spr].get_width()) // 2)), (98 + (32 - asprs[avars[3][5]][spr].get_height()))])
        else:
            screen.blit(gamebk, [0, 0])
            if end == 3:
