...
def game(avars, asprs, screen):
    ...
    while kr:
        if tuts:
            ...
            screen.blit(opps[ops], [(136 - (16 * (end == 1 and omove == 1))), 98])
            screen.blit(pygame.transform.flip(asprs[avars[3][5]][spr], 1, 0), [(72 + (16 * (end == 1 and ymove == 1))), 98])
        else:
            screen.blit(playbk, [0, 0])
            if end == 3:
        ...
        if anifr < 23:
            ...
            if strt:
                ...
                if end == 0:
                    ...
                    if 0 < (omove + ymove) < 4:
                        if (omove == 1 and ymove < 2) or (ymove == 1 and omove == 2):
                            life[0] -= 1
                        if (ymove == 1 and omove < 2) or (omove == 1 and ymove == 2):
                            life[1] -= 1
                    pygame.mixer.stop()
