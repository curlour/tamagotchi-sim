...
def game(avars, asprs, screen):
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/balancet.png").convert()

    gamebk = pygame.image.load("Sprites/Misc/bg/gamecenter.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/balance.png").convert()
    ...
    bl1 = pygame.image.load("Sprites/Misc/obj/blkp1.png").convert()
    bl2 = pygame.image.load("Sprites/Misc/obj/blkp2.png").convert()
    bl3 = pygame.image.load("Sprites/Misc/obj/blkp3.png").convert()
    bl4 = pygame.image.load("Sprites/Misc/obj/blkp4.png").convert()
    bll = [bl1, bl2, bl3, bl4]
    ...
    while kr:
        if tuts:
            ...
            screen.blit((fnt.render(("%02d" % scr), 1, (0, 0, 100))), [56, 60])
            if end == 0:
                if anifr % 3 == 0:
                    bp *= 2
                if abs(bp) > 1024:
                ...
                if scr < 12:
                    ...
                    spr = 5
            screen.blit(asprs[avars[3][5]][spr], [(104 + ((32 - asprs[avars[3][5]][spr].get_width()) // 2)), (98 + (32 - asprs[avars[3][5]][spr].get_height()))])
            screen.blit(pygame.transform.flip(bll[bls], (bp < 0), 0), [blx, (58 - (3 * (asprs[avars[3][5]][spr].get_height() // 4)))])
        else:
            screen.blit(gamebk, [0, 0])
            if end == 3:
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    elif 24 < mp[1] < 136 and play and end == 0:
                        if bp == 1:
                            bp = -1
                        elif bp < 0:
                            bp *= 2
