...
def game(avars, asprs, screen):
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/toyt.png").convert()

    playbk = pygame.image.load("Sprites/Misc/bg/toy.png").convert()

    toys = [pygame.image.load("Sprites/Misc/item/plush.png").convert(),
            pygame.image.load("Sprites/Misc/item/yoyo.png").convert(),
            pygame.image.load("Sprites/Misc/item/phouse.png").convert(),
            pygame.image.load("Sprites/Misc/item/ufo2.png").convert()]
    ...
    while kr:
        if tuts:
            ...
            if end == 0:
                spr = 6
                screen.blit(toys[toy], [108, 36])
            elif end == 1:
                spr = 3 + (anifr % 12 > 5)
            else:
                spr = 5 + (2 * (tool != tlis[toy]))
                if tool in tlis:
                    screen.blit(toys[tlis.index(tool)], [108, 36])
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        strt = True
                        anifr = -1
                    if (24 < mp[1] < 136) and play and end == 1:
                        pygame.mixer.stop()
                        sound[2].play()
                        tool.append(mp[0] // 80)
                        tool.sort()
