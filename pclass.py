...
def game(avars, asprs, screen):
    ...
    pos = list(range(6))
    shuffle(pos)
    act = [randint(0, 1), randint(0, 1), randint(0, 1), randint(0, 1)]
    ...
    tutimg = pygame.image.load("Sprites/Misc/bg/pclasst.png").convert()

    classbg = pygame.image.load("Sprites/Misc/bg/pasclass.png").convert()
    blackbg = pygame.image.load("Sprites/Misc/bg/wipebg.png").convert()

    wipeob = pygame.image.load("Sprites/Misc/obj/wipeob.png").convert()

    dirt = [pygame.image.load("Sprites/Misc/bg/wipebg1.png").convert(), pygame.image.load("Sprites/Misc/bg/wipebg2.png").convert(),
            pygame.image.load("Sprites/Misc/bg/wipebg3.png").convert(), pygame.image.load("Sprites/Misc/bg/wipebg4.png").convert(),
            pygame.image.load("Sprites/Misc/bg/wipebg5.png").convert(), pygame.image.load("Sprites/Misc/bg/wipebg6.png").convert()]

    studs = [chsprs(randint(49, 132)), chsprs(randint(49, 132)),
             chsprs(randint(49, 132)), chsprs(randint(49, 132))]
    ...
    while kr:
        if tuts:
            ...
            if end < 1 or scr < 12:
                for i in range(6):
                    screen.blit(dirt[i], [[64, 10, 148, 170, 119, 19][i], [120, 110, 92, 49, 95, 43][i]])
                for i in range(4):
                    screen.blit(pygame.transform.flip(wipeob, (pos[i] % 2 == 0), 0), [([64, 20, 150, 182, 120, 32][pos[i]] + (4 * ((anifr % 12 < 6) and act[i]))), [120, 106, 84, 62, 87, 59][pos[i]]])
                    screen.blit(pygame.transform.flip(studs[i][[6, 3][act[i]]], (pos[i] % 2 == 0), 0), [[44, 58, 120, 200, 88, 60][pos[i]], [110, 100, 106, 80, 92, 80][pos[i]]])
            screen.blit(asprs[avars[3][5]][spr], [184, 98])
        else:
            screen.blit(classbg, [0, 0])
            if end == 3:
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pb == 1:
                    ...
                    if (24 < mp[1] < 136) and tuts:
                        ...
                        if 64 < mp[0] < 112 and 120 < mp[1] < 136 and pos.index(0) < 4:
                            act[pos.index(0)] = 1
                        if 10 < mp[0] < 52 and 110 < mp[1] < 124 and pos.index(1) < 4:
                            act[pos.index(1)] = 1
                        if 148 < mp[0] < 186 and 92 < mp[1] < 130 and pos.index(2) < 4:
                            act[pos.index(2)] = 1
                        if 170 < mp[0] < 213 and 49 < mp[1] < 75 and pos.index(3) < 4:
                            act[pos.index(3)] = 1
                        if 119 < mp[0] < 149 and 95 < mp[1] < 115 and pos.index(4) < 4:
                            act[pos.index(4)] = 1
                        if 19 < mp[0] < 61 and 43 < mp[1] < 91 and pos.index(5) < 4:
                            act[pos.index(5)] = 1
